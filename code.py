...
from lib.jophur.states import MenuStateMachine, InitMenu, MainMenu
...
async def main():
    ...
    listener = Listener()
    state_machine = MenuStateMachine({
        "Init": InitMenu(jophur),
        "Main": MainMenu(jophur, listener),
    })
